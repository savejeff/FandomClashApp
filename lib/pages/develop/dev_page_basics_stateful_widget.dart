...
// The Counter widget with configuration data (incrementStep).
class Counter extends StatefulWidget {
  // Configuration data, immutable once passed to the StatefulWidget
  final int incrementStep;

  // Callback function to set count from outside
  final Function(int)? onCountChanged;

  // Constructor with the configuration data and callback
  Counter({required this.incrementStep, this.onCountChanged});
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            setState(() {
              count += widget.incrementStep; // Use the configuration data to update the count
            });
            widget.onCountChanged?.call(count);
          },
          child: Text('Increment by ${widget.incrementStep}'),
        ),
      ],
    );
  }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Counter(incrementStep: incrementStep,
                    onCountChanged: (count) {
                      LogX("On Counter Change %d", [count]);
